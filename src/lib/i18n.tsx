...
const es: Dict = {
  ...
  "part.field.kg_reciclado_manual": "Industria (cítricos manual)",
  "part.field.kg_reciclado_malla_z1": "Reciclado Z1 (boxes azules)",
  "part.field.kg_reciclado_malla_z2": "Reciclado Z2 (boxes azules)",
  "part.field.kg_podrido_manual": "Podrido manual (volcador)",
  "part.field.kg_inventario": "Inventario final (palets sin alta)",
  "part.field.kg_palets_pendientes_anterior": "Inventario final del día anterior",
  "part.field.kg_palets_pendientes_anterior.help": "Palets del día anterior que se dan de alta hoy. Se restan para no contar producción de ayer.",
  ...
  "part.cascade.title": "Cascada DSJ",
  "part.cascade.production": "Producción calibrador",
  "part.cascade.plus_industria": "+ Industria",
  "part.cascade.minus_mujeres_l": "− Mujeres (L)",
  "part.cascade.minus_reciclado_z1": "− Reciclado Z1",
  "part.cascade.minus_reciclado_z2": "− Reciclado Z2",
  "part.cascade.produccion_real": "Producción real",
  "part.cascade.minus_palets": "− Palets ajustados (alta − inv. ant.)",
  "part.cascade.minus_inventario_neto": "− Inventario final",
  "part.cascade.minus_podrido_calib": "− Podrido calibrador",
  "part.cascade.minus_podrido_manual": "− Podrido manual",
  "part.cascade.gross_diff": "Diferencia bruta",
  "part.cascade.dsj": "DSJ (Diferencia Sin Justificar)",
  "part.cascade.dsj_help": "Diferencia entre lo que dicen los informes y lo realmente producido, una vez descontadas las mermas justificadas",
...
const en: Dict = {
  ...
  "part.field.kg_reciclado_manual": "Industry (manual citrus)",
  "part.field.kg_reciclado_malla_z1": "Recycled Z1 (blue boxes)",
  "part.field.kg_reciclado_malla_z2": "Recycled Z2 (blue boxes)",
  "part.field.kg_podrido_manual": "Manual rotten (tipper)",
  "part.field.kg_inventario": "Final inventory (unregistered pallets)",
  "part.field.kg_palets_pendientes_anterior": "Previous day's final inventory",
  "part.field.kg_palets_pendientes_anterior.help": "Previous day pallets registered today. Subtracted to avoid counting yesterday's production.",
  ...
  "part.cascade.plus_industria": "+ Industry",
  "part.cascade.minus_mujeres_l": "− Women (L)",
  "part.cascade.minus_reciclado_z1": "− Recycled Z1",
  "part.cascade.minus_reciclado_z2": "− Recycled Z2",
  "part.cascade.produccion_real": "Real production",
  "part.cascade.minus_palets": "− Adjusted pallets (registered − prev. inv.)",
  "part.cascade.minus_inventario_neto": "− Final inventory",
  "part.cascade.minus_podrido_calib": "− Calibrator rotten",
  "part.cascade.minus_podrido_manual": "− Manual rotten",
  "part.cascade.gross_diff": "Gross difference",
  "part.cascade.dsj": "UJD (Unjustified Difference)",
  "part.cascade.dsj_help": "Gap between reported production and actual output, after justified shrinkage is deducted",
