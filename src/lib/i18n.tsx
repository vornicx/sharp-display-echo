...
const es: Dict = {
  ...
  "part.cascade.production": "Producción total (calibrador)",
  "part.cascade.plus_industria": "+ Industria / Cítricos manual",
  ...
  "part.cascade.minus_reciclado_manual": "− Reciclado manual (box azules)",
  ...
  "part.cascade.unjustified_help": "Diferencia entre lo que dicen los informes y lo realmente producido",
...
const en: Dict = {
  ...
  "part.field.kg_reciclado_manual": "Manual recycled (blue boxes)",
  ...
  "part.cascade.production": "Total production (calibrator)",
  "part.cascade.plus_industria": "+ Industry / Manual citrus",
  ...
  "part.cascade.minus_reciclado_manual": "− Manual recycled (blue boxes)",
  ...
  "part.cascade.unjustified_help": "Gap between reported production and what was actually produced",
